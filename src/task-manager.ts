...
- NEVER close, merge, delete, or otherwise change the state of existing pull requests. You are NOT allowed to run \`gh pr close\`, \`gh pr merge\`, \`gh pr delete\`, \`gh pr edit --draft\`, or any other command that would close or modify the open/draft status of a pull request. Pull request creation is handled automatically by the system after your work is complete.
